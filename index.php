...
while ($platform_check = $respl->fetch_assoc())
{
    if ($platform_check['platform_name'] == 'ERR')
    {
        continue;
    }
    $platformList[$platform_check['platform_id']] = $platform_check['platform_name'];
}
